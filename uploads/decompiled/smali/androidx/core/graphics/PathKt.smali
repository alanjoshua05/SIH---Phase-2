...
.method public static final and(Landroid/graphics/Path;Landroid/graphics/Path;)Landroid/graphics/Path;
    ...
    .line 72
    invoke-static {}, Landroidx/core/os/BundleKt$$ExternalSyntheticApiModelOutline0;->m$2()Landroid/graphics/Path$Op;

    move-result-object v1

    invoke-static {v0, p0, p1, v1}, Landroidx/core/os/BundleKt$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Path;Landroid/graphics/Path;Landroid/graphics/Path;Landroid/graphics/Path$Op;)Z
...
.method public static final minus(Landroid/graphics/Path;Landroid/graphics/Path;)Landroid/graphics/Path;
    ...
    .line 55
    invoke-static {}, Landroidx/core/os/BundleKt$$ExternalSyntheticApiModelOutline0;->m$3()Landroid/graphics/Path$Op;

    move-result-object p0

    invoke-static {v0, p1, p0}, Landroidx/core/os/BundleKt$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Path;Landroid/graphics/Path;Landroid/graphics/Path$Op;)Z
...
.method public static final xor(Landroid/graphics/Path;Landroid/graphics/Path;)Landroid/graphics/Path;
    ...
    .line 82
    invoke-static {}, Landroidx/core/os/BundleKt$$ExternalSyntheticApiModelOutline0;->m$1()Landroid/graphics/Path$Op;
